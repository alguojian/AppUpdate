...
public class NumberProgressBar extends View {
    ...
    private final int default_text_color = Color.rgb(89, 129, 250);
    private final int default_reached_color = Color.rgb(89, 129, 250);
    ...
    public NumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mReachedBarHeight = dp2px(2f);
        mUnreachedBarHeight = dp2px(1.5f);
